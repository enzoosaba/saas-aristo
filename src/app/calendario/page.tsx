...
export default function CalendarioPage() {
  ...
  return (
    <div className="workspace-page flex flex-col gap-4">
      <h1>Calendário</h1>
      <p className="page-description">Sua agenda, conectada à rotina.</p>
      ...
      <Card>
        <div className="panel-title">
          <h2>Provas e simulados</h2>
        </div>
        <div className="study-empty">
          <strong>Nenhuma prova cadastrada</strong>
          <p>
            Por enquanto, você pode organizar seus compromissos como tarefas com
            data e horário.
          </p>
        </div>
      </Card>
